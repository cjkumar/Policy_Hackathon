...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov 16 19:24:40 2024
...
def calculate_jaccard(data_subset):
    ...
    intersection = ((data_subset['test_prediction'] == 0) & (data_subset['hypoxic'] == 0)).sum()
    #print(intersection)
    # Union of predicted and actual hypoxic
    union = ((data_subset['test_prediction'] == 0) | (data_subset['hypoxic'] == 0)).sum()
    #print(union)
    # Jaccard coefficient
...
# Calculate overall Jaccard coefficient
overall_jaccard = calculate_jaccard(data)
print(f"Overall Jaccard Coefficient: {overall_jaccard:.2f}")

# Calculate Youden's J statistic and Jaccard coefficient for each race/ethnicity group
results = {}
